...
#! of finite sets.
#! @Arguments object
@DeclareFilter( "IsCategoryOfFiniteSets",
                  IsCapCategory );
...
#! of finite sets.
#! @Arguments object
@DeclareFilter( "IsObjectInCategoryOfFiniteSets",
                 IsCapCategoryObject );
...
#! of finite sets.
#! @Arguments object
@DeclareFilter( "IsMorphismInCategoryOfFiniteSets",
...
@BindGlobal( "IsCategoryOfFinSets", IsCategoryOfFiniteSets );
@BindGlobal( "IsFiniteSet", IsObjectInCategoryOfFiniteSets );
@BindGlobal( "IsFiniteSetMap", IsMorphismInCategoryOfFiniteSets );
@BindGlobal( "CategoryOfFinSets", CategoryOfFiniteSets );
